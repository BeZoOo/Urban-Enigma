...
//         console.log( $(this).scrollTop() );
    ...
    $('.close-popup, .popup-bg, .continueshopping-incart').click(function () {
        $('.pop-up-cat').css({'z-index': '-2', 'opacity': 0, 'top': '10%'});
        $('.fixed-popup').css('z-index', '-2');
        $('.popup-bg').css({'z-index': '-2', 'opacity': 0});
      ...
      $('#cart-xs').click(function () {
          $('#cart-screen').css({'z-index': '99999', 'opacity': 1, 'transition': '0.5s all ease-in-out', 'top': '6%',});
          $('body').css("overflow", "hidden");
      });
